...
def build_rnn(init):
    ...
    l_dropout_1 = lasagne.layers.DropoutLayer(l_in, p=0.2)

    l_forward_1 = lasagne.layers.GRULayer(
            l_dropout_1, N_HIDDEN,
    ...
    l_dropout_2 = lasagne.layers.DropoutLayer(l_concat1, p=0.5)

    l_forward_2 = lasagne.layers.GRULayer(
            l_dropout_2, N_HIDDEN,
            only_return_final=False)
    ...
    l_dropout_3 = lasagne.layers.DropoutLayer(l_concat2, p=0.5)

    l_forward_3 = lasagne.layers.GRULayer(
            l_dropout_3, N_HIDDEN,
            only_return_final=False)
    ...
    l_dropout_4 = lasagne.layers.DropoutLayer(l_concat3, p=0.5)

    l_shp = lasagne.layers.ReshapeLayer(l_dropout_4, (-1, N_HIDDEN))
